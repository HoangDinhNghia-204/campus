...
class __TwigTemplate_84184173508eb1cb2cda3b6eb1eef3fa extends Template
{
  ...
  ";
        // line 36
        $context["legend_span_classes"] = ["fieldset-legend", "fieldset__label", (((($tmp =         // line 39
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("js-form-required") : ("")), (((($tmp =         // line 40
($context["required"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ("form-required") : (""))];
  ...
  <div class=\"fieldset-wrapper\">
    ...
    ";
        ...
        // line 59
        yield "    ";
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 59)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 60
            yield "      <div";
...
";
    ...
    {
        return new Source("", "modules/contrib/media_library_form_element/templates/media-library-element.html.twig", "D:\\wamp64\\www\\campus-project\\web\\modules\\contrib\\media_library_form_element\\templates\\media-library-element.html.twig");
    }
